...
<section>
    ...
    <ul class="ulcolumn2">
        <li><span class="item_name" style="width: 120px;text-align: right">朋友圈分享名称：</span><input class="alt-config textbox textbox_295" type="text"id="timeLineTitle"value="<?php echo $config['timeLineTitle']?>"/> </li>
        <li><span class="item_name" style="width: 120px;text-align: right">好友分享名称：</span><input class="alt-config textbox textbox_295" type="text"id="appMessageTitle"value="<?php echo $config['appMessageTitle']?>"/> </li>
        <li><span class="item_name" style="width: 120px;text-align: right">好友分享描述：</span><textarea class="textarea alt-config"id="appMessageDesc"style="width: 500px;height: 100px"><?php echo $config['appMessageDesc']?></textarea> </li>
    </ul>
