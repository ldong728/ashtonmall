...
<div class="wrap">
<div class="pDetail">
<a href="controller.php?getList=1&c_id=<?php echo $cate['id'] ?>">
...
<div class="param module-box">
    <div class="title" id="param-title">
...
<!--        --><?php //endforeach ?>
        <dl style="float: left">
            <dt></dt>
            <dd><?php echo $paramvalue ?></dd>
        </dl>

    </div>
</div>
<div class="review-module module-box">
    <div class="title" id="review-title">
        <div class="line-number">5</div>
        <div class="title-name">查看评价</div>
    </div>
    <div class="hidden-content review" id="detail-review" style="display: none">
